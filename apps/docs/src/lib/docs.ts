...
const DOCS_MAP: Record<string, { filePath: string; category: string; defaultTitle: string; defaultDesc: string }> = {
  introduction: {
    filePath: "../../README.md",
    category: "Getting Started",
    defaultTitle: "Introduction",
    defaultDesc: "Overview of the ObservabilityOS DevOps Intelligence Platform."
  },
  quickstart: {
  ...
  installation: {
    ...
    defaultDesc: "System requirements, environment setups, and production configurations."
  },
  development: {
    filePath: "../../docs/DEVELOPMENT.md",
    category: "Getting Started",
    defaultTitle: "Local Development",
    defaultDesc: "Running workspace tests, local commands, and sandbox debugging."
  },
  architecture: {
    filePath: "../../docs/ARCHITECTURE.md",
    category: "Core Architecture",
    defaultTitle: "System Architecture",
    defaultDesc: "Monorepo topology, log ingestion flow, and anomaly detection loops."
  },
  database: {
    filePath: "../../docs/DATABASE.md",
    category: "Core Architecture",
    defaultTitle: "Database Schemas",
    defaultDesc: "MongoDB Mongoose models, index settings, and Redis cache structures."
  },
  security: {
    filePath: "../../docs/SECURITY.md",
    category: "Core Architecture",
    defaultTitle: "Security Policy",
    defaultDesc: "Encryption, rate limit parameters, and PII data scrubbing rules."
  },
  api: {
    filePath: "../../docs/API.md",
    category: "Reference Guides",
    defaultTitle: "API Specification",
    defaultDesc: "REST API schema specifications for Ingest, Metrics, and queries."
  },
  deployment: {
    filePath: "../../docs/DEPLOYMENT.md",
    category: "Reference Guides",
    defaultTitle: "Production Deployment",
    defaultDesc: "Docker configuration, Vercel pipeline settings, and health checkups."
  },
  troubleshooting: {
    filePath: "../../docs/TROUBLESHOOTING.md",
    category: "Reference Guides",
    defaultTitle: "Troubleshooting Guide",
    defaultDesc: "Common errors like date formats hydration mismatches and database timeouts."
  },
  faq: {
    filePath: "../../docs/FAQ.md",
    category: "Reference Guides",
    defaultTitle: "Technical FAQ",
    defaultDesc: "Common developer questions on OpenTelemetry compatibility and AI privacy."
  },
  contributing: {
    filePath: "../../docs/CONTRIBUTING.md",
    category: "Community & Releases",
    defaultTitle: "Contributing Guide",
    defaultDesc: "Git branching workflows, Conventional Commits, and code review criteria."
  },
  roadmap: {
...
export function getPrevNextLinks(currentSlug: string): { prev: PrevNextLink | null; next: PrevNextLink | null } {
  ...
  const next = currentIndex < flatItems.length - 1 && currentIndex !== -1 ? flatItems[currentIndex + 1] : null;
