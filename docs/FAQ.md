...
**No.** The self-host Source-Available edition is completely free. You run it on your own infrastructure with your own API keys. The billing management page is disabled for self-host projects — all features are unlocked without any subscription or payment.
